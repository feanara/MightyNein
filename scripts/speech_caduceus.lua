...
return {
	ACTIONFAIL =
	{
		...
		STORE =
		{
			GENERIC = "I have so much stuff.",
			NOTALLOWED = "That doesn't belong there.",
		},
	},
	ACTIONFAIL_GENERIC = "That doesn't seem to work.",
	ANNOUNCE_ADVENTUREFAIL = "That didn't go well. I'll have to try again.",
	ANNOUNCE_BEES = "Hello bees! Bees?",
	...
	ANNOUNCE_DUSK = "It's almost bedtime.",
	ANNOUNCE_EAT =
	{
		GENERIC = "Yum!",
		PAINFUL = "I don't feel so good.",
		SPOILED = "Yuck! That was terrible!",
		STALE = "That was less fresh than it used to be.",
		INVALID = "No thank you.",
	},
	ANNOUNCE_ENTER_DARK = "It's too dark, I don't like it!",
	ANNOUNCE_ENTER_LIGHT = "The light! It's so beautiful!",
	ANNOUNCE_FREEDOM = "I'm free! I'm finally free!",
	ANNOUNCE_HIGHRESEARCH = "I'm not so smart.",
	ANNOUNCE_HOUNDS = "That animal sounds hungry.",
	ANNOUNCE_HUNGRY = "my stomach's pretty empty.",
	ANNOUNCE_HUNT_BEAST_NEARBY = "I think I'm getting close.",
	ANNOUNCE_HUNT_LOST_TRAIL = "Oh, he disappeared.",
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "This mud is too gooshy.",
	ANNOUNCE_INV_FULL = "I have too much stuff!",
	ANNOUNCE_KNOCKEDOUT = "Ugh, my head!",
	ANNOUNCE_LOWRESEARCH = "I didn't learn very much from that.",
	ANNOUNCE_MOSQUITOS = "Please find someone else, friend.",
	...
	ANNOUNCE_SHELTER = "Thank you tree!",
	ANNOUNCE_THORNS = "Ow!",
	...
	ANNOUNCE_WORMHOLE = "That was weird...I don't like it.",
	...
	ANNOUNCE_TOOL_SLIP = "Wow that tool is slippery! Tee hee.",
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "Yikes, that was close!",

	ANNOUNCE_DAMP = "I guess I needed a bath.",
	ANNOUNCE_WET = "I think I'm clean now.",
	ANNOUNCE_WETTER = "Rain, rain, go away please.",
	ANNOUNCE_SOAKED = "I think I'm turning into water!",
	...
	DESCRIBE =
	{
		...
		MUSHTREE_MEDIUM="It smells like Cadeucus.",
		...
		AXE = "I can chop things with it.",
		BABYBEEFALO = "Awwww. So cute!",
		BACKPACK = "I wish it was pink.",
		BACONEGGS = "I cooked it myself!",
		BANDAGE = "I guess I'll be a healer today.",
		...
		ICEPACK = "Nice and chilly.",
		BEARGER_FUR = "A mat of thick fur.",
		BEDROLL_STRAW = "It smells like wet.",
		BEE =
		{
			GENERIC = "Hello bees!",
			HELD = "Oh he's just so cute!",
		},
		BEEBOX =
		{
			FULLHONEY = "Mmm, so much honey...",
			GENERIC = "Hello bees!",
			NOHONEY = "It's empty.",
		...
		BEEFALO =
		{
			...
			GENERIC = "He smells like pewp.",
			NAKED = "That wasn't a very good haircut.",
			SLEEPING = "He's sleeping like a baby.",
		},
		BEEFALOHAT = "What a nice hat.",
		BEEFALOWOOL = "So warm and fluffy.",
		BEEHAT = "Maybe we can be friends now.",
		BEEHIVE = "Hello bees!",
		BEEMINE = "They don't sound too happy.",
		...
		CATCOONHAT = "I'm a cute Frumpkin!",
		COONTAIL = "It's okay, Caleb can bring him back.",
		...
		FLOWER = "I had a friend who collected flowers.",
		...
		GHOST = "I bet he would like Tusk Love.",
		...
		GOLDNUGGET = "It's like I got an allowance again!",
		GRASS =
		{
			BARREN = "It needs poop.",
			WITHERED = "Look, he's so hot he's dying.",
			BURNING = "AH! HOT HOT HOT!",
		...
		{
			GENERIC = "It's a mushroom.",
			INGROUND = "Shh, it's sleeping.",
			PICKED = "I wonder if it will come back?",
		},
		GUNPOWDER = "Good for Fluffernutters!",
		HAMBAT = "Ew, it smells like meat.",
		HAMMER = "What else can I destroy with this?",
		HEALINGSALVE = "The stinging means that it's working.",
		HEATROCK =
		{
			FROZEN = "It's colder than ice.",
			COLD = "That's a cold stone.",
			GENERIC = "What a cute rock. I should name it.",
			WARM = "Mmm, it's so warm and snuggly!",
			HOT = "Nice and toasty hot!",
		},
		HOME = "Someone must live here.",
		HOMESIGN = 
		{
			GENERIC = "I should draw a dick on it.",
		...
		HORN = "It's so much bigger than mine.",
		HOUND = "I miss Nugget.",
		HOUNDBONE = "Creepy.",
		HOUNDMOUND = "That's a lot of dead things.",
		ICEBOX = "I'm gonna put food in here!",
		ICEHAT = "Chilly!.",
		ICEHOUND = "Oh, that one's blue!",
		INSANITYROCK =
		{
		...
		KILLERBEE =
		{
			...
			HELD = "He seems so grumpy.",
		},
		KNIGHT = "I read a book about a handsome knight once!",
		...
		LIGHTNING_ROD =
		{
			CHARGED = "It's so bright!",
			GENERIC = "Just wait till I charge it up!",
		},
		LIGHTNINGGOAT = 
		{
		...
		GOATMILK = "I love milk.",
		LITTLE_WALRUS = "He won't be cute and cuddly forever.",
		LIVINGLOG = "It looks worried.",
		LOCKEDWES = "Maxwell's statues are trapping him.",
		LOG =
		{
			BURNING = "That's some hot wood! Tee hee.",
			GENERIC = "That's some big wood...heh heh.",
		},
		LUREPLANT = "It's so alluring.",
		LUREPLANTBULB = "Now I have my own ugly plant pet.",
		MALE_PUPPET = "He's trapped!",
		MANDRAKE =
		{
			DEAD = "He doesn't look very tasty.",
			GENERIC = "It's so weeeird!",
			PICKED = "Stop following me!",
		},
		MANDRAKESOUP = "I cooked it myself!",
		MANDRAKE_COOKED = "It still doesn't look very tasty.",
		MARBLE = "It looks like the Chateau!",
		...
		PAPYRUS = "These would make good Traveler pamphlets.",
		PENGUIN = "He's wearing a little suit!",
		...
		PICKAXE = "I use this to break rocks. And faces.",
		PIGGYBACK = "I feel kinda bad for that.",
		PIGHEAD = 
		{	
			GENERIC = "Oh, he's very dead.",
			BURNT = "Crispy.",
		},
		PIGHOUSE =
		{
		...
		FERTILIZER = "That is definitely a bucket full of pewp.",
		...
		{
			DEAD = "Ewwww!",
			GENERIC = "At least this one can't teleport.",
			SLEEPING = "He looks kind of cute when he's asleep.",
		},
		SPIDERDEN = "Sticky!",
		SPIDEREGGSACK = "I hope these don't hatch in my pocket.",
		SPIDERGLAND = "It's squishy.",
		SPIDERHAT = "I hope I got all of the spider goo out of it.",
		SPIDERQUEEN = "AHHHHHHHH! Momma spider!",
		SPIDER_WARRIOR =
		{
			DEAD = "Good riddance!",
		...
		SPOILED_FOOD = "Ew. It smells really gross.",
		...
		TELEPORTATO_BOX = "What's inside? I need to know!",
		TELEPORTATO_CRANK = "It's hard to turn.",
		TELEPORTATO_POTATO = "Oh good, a big metal potato.",
		TELEPORTATO_RING = "This thing looks magical.",
		TELESTAFF = "It can show me the world.",
		TENT = 
		{
			GENERIC = "I love camping.",
		...
		TENTACLE = "*whispers* Uk'otoa.",
		TENTACLESPIKE = "It's so sharp.",
		TENTACLESPOTS = "Ew, it's really slimy.",
		...
		TRAP = "I wonder what I'll catch.",
		TRAP_TEETH = "Nom nom nom.",
		...
		TUMBLEWEED = "It's like nature's treasure chest.",
		...
		TURKEYDINNER = "Mmmm, it's homey.",
		TWIGS = "So many little sticks.",
		...
		WINTEROMETER = 
		{
			GENERIC = "It measures winter...I think?",
	...
	DESCRIBE_GENERIC = "But what is it?",
